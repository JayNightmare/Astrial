...
module.exports = async (client, track) => {
  ...
  client.manager.on("playerEmpty", async (player) => {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription("Enjoying Music with me? Consider [Inviting](https://discordapp.com/oauth2/authorize?client_id=1050445107389804646&permissions=8&scope=applications.commands%20bot) me!");
