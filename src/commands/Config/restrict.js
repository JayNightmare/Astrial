...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!message.member.permissions.has(PermissionFlagsBits.Administrator)) {
      return message.reply("<:cross:1301129244855763027> | You do not have permission to use this command.");
    }
    ...
    if (!type) {
      return message.reply("<:cross:1301129244855763027> | Please provide a type (e.g., `text`, `voice`, `reset`).");
    }
    ...
    if (!channel) {
      return message.reply("<:cross:1301129244855763027> | Please mention a valid channel or provide a valid channel ID.");
    }
    ...
    if (type === "text") {
      ...
      if (restrictionData.restrictedTextChannels.includes(channel.id)) {
        return message.reply("<:cross:1301129244855763027> | This text channel is already restricted.");
      }
      ...
      if (restrictionData.restrictedVoiceChannels.includes(channel.id)) {
        return message.reply("<:cross:1301129244855763027> | This voice channel is already restricted.");
      }
