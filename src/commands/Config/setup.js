    ...
    try {
      ...
      if (args[0].toLowerCase() === "create") {
        ...
        let em = new EmbedBuilder()
          ...
          .setDescription(`**Unleash Your Music Vibes with Astrial!** : Join us in the voice chat and request your favorite songs! Experience the ultimate sound quality and let the music take you higher!`)
