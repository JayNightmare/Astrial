...
module.exports = {
  ...
  run: async (client, message, args, prefix) => {
    let sumant = ['1203569730385084476', '373097473553727488'];
      if (!sumant.includes(message.author.id)) return message.reply({content : `<:cross:1301129244855763027> | Be my owner to run this command.`})
