        ...
        try {
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: "How to Upgrade?", value: "Visit [our Support Server](https://discord.gg/kSwwUD8RDe) to subscribe & contact the server admin to unlock premium features." }
                )
